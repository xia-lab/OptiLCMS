...
private:
  ...
  List lipidsPerformDeco(){
    ...
    for(int i=0; i<ContmGroupIdxVec.size(); i++) { //ContmGroupIdxVec.size()
      ...
      vector<NumericMatrix> main_candidate_msms = lipidsExtractMainCandidates(SQLiteObj, thisSpectra, thisMz, 
  ...
  static vector<NumericMatrix> lipidsExtractMainCandidates(SqliteDriver SQLiteObj, 
...
public:
  ...
  void lipidsSetDDA_Arguments(NumericMatrix pm, 
  ...
  void lipidsPerformDDAProcess_core(bool decoOn, bool showOutput) {
    if(showOutput){
    ...
    if(!decoOn) {
      ...
      List decoSpecRes = lipidsPerformDeco();
      tmpmtx = decoSpecRes;
...
List PerformLipidDDA_main(NumericMatrix pm,
                          NumericVector scant1,
                          NumericVector scant2,
                          List scanms1,
                          List scanms2,
