...
# 
# mSet <- PerformROIExtraction("/home/qiang/Downloads/cdf_example/mz_QE/tmp/nonzip/",rt.idx = 0.9)
# param_initial <- SetPeakParam(platform = "UPLC-Q/E");
# PeakPicking_prep <- MetaboAnalystR:::PeakPicking_prep
# 
# param_optimized <- PerformParamsOptimization(mSet, param = param_initial, ncore = 8)
