...
plan <- running.plan(plan,
                     ...
                     mSet <- PerformROIExtraction(datapath = data_folder_QC, rt.idx = 0.8, plot = F, running.controller = rc),
                     ...
                     mSet <- PerformPeakProfiling(mSet = mSet, Params = SetPeakParam(ppm = 5,bw = 10), plotSettings = plotSettings2, running.controller = rc),
